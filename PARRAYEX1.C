/* Write a program asks from the user number of countries.
 Then declare an array called GDP with as much size. 
Now read and print the Gross Domestic Products of the countries. */
# include <stdio.h>
